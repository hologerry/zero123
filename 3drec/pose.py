...
SIDEVIEW_PROMPTS = ["front view of", "side view of", "backside view of", "side view of"]
...
def spiral_poses(
    ...
    poses = [camera_pose(e, center - e, up) for e in eyes]
    return poses
...
class Poser:
    ...
    def sample_train(self, n):
        ...
        up = self.up
        poses = [camera_pose(e, -e, up) for e in eyes]
        poses = np.stack(poses, 0)
        random_Ks = [self.K for i in range(len(poses))]  # objaverse
